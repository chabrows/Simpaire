...
relative_difference_mean_max_minus_0_deg_r = pd.read_csv("C:\\Users\\lea.chabrowski\\Desktop\\new_standardization\\relative_difference_Right_hip_red_max_minus_0_deg_6_corrected_measure_r.csv")
relative_difference_mean_max_minus_0_deg_l = pd.read_csv("C:\\Users\\lea.chabrowski\\Desktop\\new_standardization\\relative_difference_Right_hip_red_max_minus_0_deg_6_corrected_measure_l.csv")

relative_difference_mean_max_minus_3_deg_r = pd.read_csv("C:\\Users\\lea.chabrowski\\Desktop\\new_standardization\\relative_difference_Right_hip_red_max_minus_3_deg_9_corrected_measure_r.csv")
relative_difference_mean_max_minus_3_deg_l = pd.read_csv("C:\\Users\\lea.chabrowski\\Desktop\\new_standardization\\relative_difference_Right_hip_red_max_minus_3_deg_9_corrected_measure_l.csv")


relative_difference_mean_max_minus_5_deg_r = pd.read_csv("C:\\Users\\lea.chabrowski\\Desktop\\new_standardization\\relative_difference_Right_hip_red_max_minus_5_deg_4_corrected_measure_r.csv")
relative_difference_mean_max_minus_5_deg_l = pd.read_csv("C:\\Users\\lea.chabrowski\\Desktop\\new_standardization\\relative_difference_Right_hip_red_max_minus_5_deg_4_corrected_measure_l.csv")


relative_difference_mean_max_minus_7_deg_r = pd.read_csv("C:\\Users\\lea.chabrowski\\Desktop\\new_standardization\\relative_difference_Right_hip_red_max_minus_7_deg_6_corrected_measure_r.csv")
relative_difference_mean_max_minus_7_deg_l = pd.read_csv("C:\\Users\\lea.chabrowski\\Desktop\\new_standardization\\relative_difference_Right_hip_red_max_minus_7_deg_6_corrected_measure_l.csv")


relative_difference_mean_max_minus_9_deg_r = pd.read_csv("C:\\Users\\lea.chabrowski\\Desktop\\new_standardization\\relative_difference_Right_hip_red_max_minus_9_deg_4_corrected_measure_r.csv")
relative_difference_mean_max_minus_9_deg_l = pd.read_csv("C:\\Users\\lea.chabrowski\\Desktop\\new_standardization\\relative_difference_Right_hip_red_max_minus_9_deg_4_corrected_measure_l.csv")

relative_difference_mean_max_minus_11_deg_r = pd.read_csv("C:\\Users\\lea.chabrowski\\Desktop\\new_standardization\\relative_difference_Right_hip_red_max_minus_11_deg_5_corrected_measure_r.csv")
relative_difference_mean_max_minus_11_deg_l = pd.read_csv("C:\\Users\\lea.chabrowski\\Desktop\\new_standardization\\relative_difference_Right_hip_red_max_minus_11_deg_5_corrected_measure_l.csv")
...
relative_difference_mean_max_minus_13_deg_l = pd.read_csv("C:\\Users\\lea.chabrowski\\Desktop\\new_standardization\\relative_difference_Right_hip_red_max_minus_13_deg_4_corrected_measure_l.csv")
...
#z_score per row!!!!! because the parameters are per row since "both_left_and_right_concatenated_all_numpy" is a 110x7 matrix
z_scores = zscore(both_left_and_right_concatenated_all_numpy, axis=1)
...
k = 3
nbrs = NearestNeighbors(n_neighbors=k).fit(z_scores)
distances_output, indices = nbrs.kneighbors(z_scores)
...
epsilons = np.linspace(0.5, 1, num = 6)
...
best_dict2 = get_scores_and_labels(combinations, z_scores)
...
mapper = km.KeplerMapper(verbose=1)
projected_data = mapper.fit_transform(z_scores, projection =manifold.Isomap(n_components=2, n_neighbors=best_neighbohrs_ISOMAP, n_jobs=-1))

G = mapper.map(projected_data, z_scores, clusterer=sklearn.cluster.DBSCAN(eps=best_eps
